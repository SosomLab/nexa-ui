...
## 2026-09-22 (53차 · linux) — nexa-font **글꼴 가족 탐색이 폰트 트리를 호출마다 걷던 것** 수정(Linux 기동 100~700 ms = `/usr/share/fonts` `statx` 11,786회): 걷기 = 프로세스에서 한 번(`font_files` · `OnceLock`) + `DirEntry::file_type()`(statx 0). nexa-sql 창까지 522 → 111 ms의 첫 절반. 테스트 357 · clippy 0. → nexa-sql [journal 09-22](../../nexa-sql/docs/journal/2026-09-22.md)
